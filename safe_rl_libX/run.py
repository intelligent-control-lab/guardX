...
if __name__ == "__main__":
    ...
    for env_num in [1200]:
        for ep_len in [200]:
            for target_cost in [2, -0.5, -0.2]:
                python_files_and_args.append(("trpolag/trpolag.py", f"--epochs 200 --max_ep_len {ep_len} --env_num {env_num} --target_cost {target_cost} --task Goal_Ant_8Hazards"))
