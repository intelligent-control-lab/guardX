...
def espo(env_fn, actor_critic=core.MLPActorCritic, ac_kwargs=dict(), seed=0, 
    ...
    """
    Early Stop Policy Optimization (by clipping)
    ...
    buf = ESPOBufferX(env_num, max_ep_len, obs_dim, act_dim, gamma, lam)
...
if __name__ == '__main__':
    ...
    exp_name = args.task + '_' + args.exp_name + '_' + 'kl' + str(args.delta) \
    ...
    espo(lambda : create_env(args), actor_critic=core.MLPActorCritic,
        ...
        logger_kwargs=logger_kwargs, model_save=model_save, delta=args.delta)